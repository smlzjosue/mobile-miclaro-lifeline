...
(function(t) {
            ...
            this.selectees.each(function() {
              ...
              i &&
                ...
                'touch' === n.tolerance
                  ...
                  : 'fit' === n.tolerance && (h = c.left > o && r > c.right && c.top > a && l > c.bottom),
                h
            ...
            for (
              ...
              (W = m ? m.apply(t.input ? t.input[0] : null, [z]) : [!0, '']),
                ...
                (E +=
                  ...
                  ((z.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent) ||
                ...
                l.options.range === !0 &&
                  ('horizontal' === l.orientation
                    ? (0 === s && l.range.stop(1, 1)[h ? 'animate' : 'css']({ left: i + '%' }, r.animate),
                      1 === s &&
                        l.range[h ? 'animate' : 'css']({ width: i - e + '%' }, { queue: !1, duration: r.animate }))
                    : (0 === s && l.range.stop(1, 1)[h ? 'animate' : 'css']({ bottom: i + '%' }, r.animate),
                      1 === s &&
                        l.range[h ? 'animate' : 'css']({ height: i - e + '%' }, { queue: !1, duration: r.animate }))),
                (e = i);
            })
          : ((s = this.value()),
            (n = this._valueMin()),
  ...
  t.effects.define('blind', 'hide', function(e, i) {
    ...
    t.effects.define('bounce', function(e, i) {
      ...
      l && ((s = { opacity: 0 }), (s[m] = (_ ? '-=' : '+=') + u), a.animate(s, f, g)),
        a.queue(i),
        ...
        for (l = m.top + o * v, c = o - (u - 1) / 2, a = 0; d > a; a++)
          (r = m.left + a * _),
            ...
            p
              ...
              .animate(
                { left: r + (g ? 0 : h * _), top: l + (g ? 0 : c * v), opacity: g ? 1 : 0 },
                e.duration || 500,
                e.easing,
                s
              );
    ...
    t.effects.define('size', function(e, i) {
      ...
      t.effects.createPlaceholder(a),
        ...
        ('box' === d || 'both' === d) &&
          (n.from.y !== n.to.y &&
            ((_ = t.effects.setTransition(a, l, n.from.y, _)), (v = t.effects.setTransition(a, l, n.to.y, v))),
          n.from.x !== n.to.x &&
            ((_ = t.effects.setTransition(a, h, n.from.x, _)), (v = t.effects.setTransition(a, h, n.to.x, v)))),
        ('content' === d || 'both' === d) &&
          n.from.y !== n.to.y &&
        ...
        ('content' === d || 'both' === d) &&
          ...
          a.find('*[width]').each(function() {
            ...
            n.from.y !== n.to.y &&
              ((o = t.effects.setTransition(i, l, n.from.y, o)), (a = t.effects.setTransition(i, l, n.to.y, a))),
              n.from.x !== n.to.x &&
                ((o = t.effects.setTransition(i, h, n.from.x, o)), (a = t.effects.setTransition(i, h, n.to.x, a))),
