...
(function(d, F, z) {
  function L(l, a, b) {
    ...
    h = d('<button type="button"></button>')
      .addClass(a + '-triggerbutton')
      .attr({ title: l.attr('title'), tabindex: l.attr('tabindex'), id: c })
      .button({ icons: { secondary: b.icon }, icon: b.icon, iconPosition: 'end', label: b.initialText });
    return {
      getElement: function() {
        return h;
      },
      ...
      enforceOptions: function() {
        h.button('option', { icons: { secondary: b.icon }, icon: b.icon, iconPosition: 'end', label: b.initialText });
      }
    };
  }
  function G(l, a, b) {
    ...
    (function() {
      ...
      g = d('<ul></ul>');
      d.ui.menu.prototype.options.items === z
        ? ((f = '<li><a href="#">'), (h = '</a></li>'))
        : ((f = '<li><div>'), (h = '</div></li>'));
  ...
  function N(l, a) {
    function b(b, f) {
      ...
      !k.start || k.end
        ? ((k.start = c), (k.end = null))
        : c < k.start
        ? ((k.end = k.start), (k.start = c))
        : (k.end = c);
      if (a.datepickerOptions.hasOwnProperty('onSelect')) a.datepickerOptions.onSelect(b, f);
    }
    function f(b) {
    ...
    var g,
      k = { start: null, end: null };
    g = d('<div></div>', { class: l + '-calendar ui-widget-content' });
    g.datepicker(d.extend({}, a.datepickerOptions, { beforeShowDay: f, onSelect: b }));
    h();
    return {
      getElement: function() {
        return g;
      ...
      enforceOptions: function() {
        g.datepicker('option', d.extend({}, a.datepickerOptions, { beforeShowDay: f, onSelect: b }));
      }
    };
  }
  function O(l, a, b) {
    ...
    a.applyButtonText &&
      ((h = d('<button type="button" class="ui-priority-primary"></button>')
        .text(a.applyButtonText)
        .button()),
      f.append(h));
    a.clearButtonText &&
      ((c = d('<button type="button" class="ui-priority-secondary"></button>')
        .text(a.clearButtonText)
        .button()),
      f.append(c));
    a.cancelButtonText &&
      ((g = d('<button type="button" class="ui-priority-secondary"></button>')
        .text(a.cancelButtonText)
        .button()),
      f.append(g));
    b && (h && h.click(b.onApply), c && c.click(b.onClear), g && g.click(b.onCancel));
    return {
      getElement: function() {
        return f;
      },
  ...
  function P(l, a, b) {
    function f() {
      if (b.autoFitCalendars) {
        var e = d(F).width(),
          ...
          h = g;
        if (c > e) {
          for (; 1 < g && n.outerWidth(!0) > e; ) a.datepicker('option', 'numberOfMonths', --g);
    ...
    function c(e) {
      var a = b.dateFormat;
      return (
        d.datepicker.formatDate(a, e.start) +
        (+e.end !== +e.start ? b.rangeSplitter + d.datepicker.formatDate(a, e.end) : '')
      );
    }
    function g(e) {
      var a = b.altFormat,
    ...
    function r() {
      var e = B();
      e ? (m.setLabel(c(e)), p.setRange(e)) : p.reset();
    }
    function A(e, d) {
      var f = e || p.getRange();
      if (f.start) {
        ...
        a._trigger('change', d, { instance: a });
      }
    }
    function B() {
      return k(l.val());
    ...
    function J(e) {
      m.reset();
      p.reset();
      if (b.onClear) b.onClear();
      a._trigger('clear', e, { instance: a });
    }
    function K(e) {
      var a = d(this),
        c = a
        ...
        a = a
          ...
          .startOf('day')
          .toDate();
      p.setRange({ start: c, end: a });
      b.applyOnMenuSelect && (q(e), A(null, e));
      return !1;
    }
    function H() {
      n.position({
        ...
        using: function(e, a) {
          var c = u,
            d,
            f = a.element.top + a.element.height / 2,
            g = a.target.top + a.target.height / 2,
            h = v;
          ...
          n.css({ left: e.left, top: e.top });
          v = f > g ? 3 : 2;
          v !== h &&
            (null !== h && m.getElement().removeClass('comiseo-daterangepicker-' + y[h]),
            m.getElement().addClass('comiseo-daterangepicker-' + y[v]));
          c =
            (3 === v && a.element.top - a.target.top !== a.target.height + b.verticalOffset) ||
            (2 === v && a.target.top - a.element.top !== a.element.height + b.verticalOffset);
    ...
    function D(e) {
      t ||
        (m.getElement().addClass('comiseo-daterangepicker-active'),
        x.show(),
        (t = !0),
        C && f(),
      ...
      a._trigger('open', e, { instance: a });
    }
    function q(e) {
      t && (n.hide(), x.hide(), m.getElement().removeClass('comiseo-daterangepicker-active'), (t = !1));
      if (b.onClose) b.onClose();
      a._trigger('close', e, { instance: a });
    }
    function I(a) {
      t ? (q(a), r()) : D(a);
    }
    ...
    (function() {
      ...
      E = O('comiseo-daterangepicker', b, {
        ...
        onCancel: function(b) {
          a._trigger('cancel', b, { instance: a });
          q(b);
          r();
        }
      });
      n = d('<div></div>', {
        class:
          'comiseo-daterangepicker comiseo-daterangepicker-' +
          y[u] +
          ' ui-widget ui-widget-content ui-corner-all ui-front'
      })
        .append(
          d('<div></div>', { class: 'comiseo-daterangepicker-main ui-widget-content' })
            .append(w.getElement())
            .append(p.getElement())
        )
        .append(d('<div class="ui-helper-clearfix"></div>').append(E.getElement()))
        .hide();
      l.hide().after(m.getElement());
      x = d('<div></div>', { class: 'ui-front comiseo-daterangepicker-mask' }).hide();
      d('body')
        .append(x)
        .append(n);
      f();
  ...
  d.widget('comiseo.daterangepicker', {
    ...
    options: {
      ...
      onChange: null,
      onClear: null,
      datepickerOptions: { numberOfMonths: 3, maxDate: 0 }
    },
    _create: function() {
